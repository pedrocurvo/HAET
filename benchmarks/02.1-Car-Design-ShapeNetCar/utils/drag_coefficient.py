...
def cal_coefficient(file_name, press_surf=None, velo_surf=None, root='/data/shapenet_car/mlcfd_data/training_data'):
    save_path = '/data/shapenet_car/mlcfd_data/preprocessed_data/param0/' + file_name
